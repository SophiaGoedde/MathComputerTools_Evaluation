...
Both SVL and latitude are simple field measurements to observe and could offer a practical way to predict further ecological traits. This is useful for species lacking detailed natural-history data (Pincheira-Donoso et al. 2011; Lambert et al. 2012). For many incidental encounters, SVL and coordinates may be the only consistent measurements available. The practicality of minimal measurements also extends to the growing contribution of citizen science. Photo-identification  platforms increasingly provide georeferenced observations, and some of which can estimate body size. Habitat protection and species-monitoring strategies have the potential to be informed by these basic descriptors through prediction of an individual’s preferred habitat. Thus, habitat associations even for sparsely documented taxa can be inferred and locations where additional individuals may be anticipated (Anderson 2003; Poe et al. 2017). 
...
In the context of lizard habitat conservation using citizen science, we asked the following questions: (1) Can female SVL and latitude accurately predict a lizard’s preferred habitat type? (2) Do preferred habitats correspond to lizard families? It was hypothesised that (H1) preferred habitat can be predicted from SVL and latitude because of known trends such as the Bergmann’s rule and demonstrated morphological trait relationships to specialized habitats (Liang et al. 2021, Oufiero et al. 2011, Munoz & Losos 2018, Meiri 2008). It was also hypothesised that (H2a)  habitats and lizard families are correlated since families often show similar tendencies due to phylogenetic similarities in behaviour and traits (O’Shea). It is further predicted that (H2b) a family’s distribution, geographic range, and predominant foraging mode can explain their relationship to preferred habitats. Foraging mode is closely tied to a populations’ diet and thus their habitat (Huey & Pianka, 1981). Range and distribution influence the habitat types available.
...
### 2.1 Predicting preferred habitat
...
### **3.1 Predicting preferred habitat**
...
### **4.1 Predicting preferred habitat**
